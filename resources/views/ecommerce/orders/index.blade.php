                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('customer.order_accept') }}" method="post"
                                                        class="form-inline" onsubmit="return confirm('Anda Yakin ?');">
                                                        @csrf
                                                        {{-- tombol view order kita bungkus JS dengan form agar rapi --}}
